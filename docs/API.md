...
| `getVersion` | `()` | `Promise<string>` (Semver; dev-ZIPs z.B. `"1.0.0-dev+abc1234"`, stable `"1.0.0"`) |
...
// "1.0.0" stable, or "1.0.0-dev+<commit>" on dev builds — see BUILD_INFO.txt in release ZIP
```
